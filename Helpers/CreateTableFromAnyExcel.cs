...
public class CreateTableFromAnyExcel(IConfiguration configuration, ITableManager tableManager)
    : IExcelTableCreator
{
    private readonly IConfiguration _configuration =
        configuration ?? throw new ArgumentNullException(nameof(configuration));
    private readonly ITableManager _tableManager =
        tableManager ?? throw new ArgumentNullException(nameof(tableManager));
